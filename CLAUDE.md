...
- **Fixed (6/4/2026)** — **Build, sorting, mobile detail, and search box fixes**: 
  ...
  - Search box is now rendered in `renderMixesList()` at the top of the Mixes list with real-time filtering by artist name or mix number.
